export const experienceData = [
  {
    ...
    responsibilities: [
      'Designed and implemented custom chatbots using AI APIs, creating tailored solutions for specific business needs and workflow automation.',
      'Leveraged AI assistants (Claude, ChatGPT, Windows Copilot, Google Gemini) to optimize code generation, automate workflows, and enhance technical documentation.',
      'Developed effective prompt engineering strategies for AI-assisted development, improving code quality and reducing development time by 40%.',
  ...
  },
  {
    ...
    dateRange: 'May 2016 - December 2022',
    responsibilities: [
  ...
  },
  {
    ...
    company: 'Earthcam',
    dateRange: 'August 2012 - August 2015',
    responsibilities: [
  ...
  },
  {
    ...
    dateRange: 'October 2011 - June 2012',
    responsibilities: [
  ...
  },
  {
    ...
    dateRange: 'March 2011 - July 2011',
    responsibilities: [
  ...
  },
  {
    ...
    dateRange: 'February 2011 - March 2011',
    responsibilities: [
  ...
  },
  {
    ...
    dateRange: '2001 - 2009',
    responsibilities: [
      'Worked closely with the store manager as the sole co-manager, supervised and trained a team of employees.',
      'Handled escalations and resolved customer complaints, delivering excellent customer service.',
      'Managed inventory levels and ensured compliance with company policies.',
      'Completed HIPAA training and adhered to privacy standards related to customer data and payments.'
    ]
  },
  {
    id: 'va',
    ...
    dateRange: 'February 2001 - June 2001',
    responsibilities: [
