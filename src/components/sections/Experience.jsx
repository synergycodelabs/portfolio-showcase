...
const Experience = ({ theme }) => {
  ...
  return (
    <>
      {/* 2) Use the SEO component here, above the main section */}
      <SEO 
        path="/experience"
        title="Experience - Angel Guevara | IT Specialist & Developer"
        description="Explore my professional background and accomplishments, showcasing extensive experience in IT leadership, system administration, and technical roles."
      />
      ...
      >
        <div className="container mx-auto px-4">
            ...
            <div className="relative p-8">
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <div className="text-center sm:text-left">
                  ...
                  >
                    I am currently seeking new challenges in IT leadership, system
                    administration, or technical roles. Let's connect and discuss how I
          ...
          <div
            className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mb-8 reveal opacity-0"
          >
